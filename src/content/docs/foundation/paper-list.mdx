...
<Card
  as='a'
  href='https://rdt-robotics.github.io/rdt2/'
  heading='RDT2: Enabling Zero-Shot Cross-Embodiment Generalization by Scaling Up UMI Data'
  subheading='基于UMI数据进一步泛化RDT能力以及零样本泛化能力。'
  date='2025-09'
>
![RDT2](./papers/RDT2.png)
</Card>
...
<Card
  as='a'
  href='https://arxiv.org/pdf/2509.151556'
  heading='Self-Improving Embodied Foundation Models'
  subheading='自进化基础模型达成数据飞轮。'
  date='2025-09'
>
![SI-foundation](./papers/googlesi.png)
</Card>
...
<Card
  as='a'
  href='https://arxiv.org/pdf/2509.11766'
  heading='Igniting VLMs toward the Embodied Space'
  subheading='自变量提出的推理-动作一体化模型。'
  date='2025-09'
>
![Self-Variable Robot](./papers/walloss.png)
</Card>
...
<Card
  ...
  subheading='基于GR00T的构建，实现了在更加泛化的人形机器人上进行训练。'
  date='2025-06'
>
![GR00T N1.5](./papers/N1_5.png)
</Card>
